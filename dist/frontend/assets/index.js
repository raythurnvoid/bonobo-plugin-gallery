...
var READY_ATTEMPTS = 20;
var REFRESH_DEADLINE_MS = 1e4;
/** @param {unknown} value */
function is_page_context(value) {
	if (typeof value !== "object" || value === null) return false;
	const context = value;
	return typeof context.pluginName === "string" && typeof context.pageId === "string" && typeof context.pageTitle === "string" && typeof context.organizationId === "string" && typeof context.workspaceId === "string";
}
/**
...
async function bonobo_ui_connect() {
	...
	if (!parentOriginParam || !bridgeNonceParam) throw new Error("Missing host bridge query params — the page must be embedded by the Bonobo host app");
	...
	*/
	async function fetchJson(path, init) {
		...
		if (response.status === 401) response = await send(await refreshToken());
		if (!response.ok) {
	...
	return new Promise((resolve, reject) => {
		...
		const handle_message = (event) => {
			...
			if (message.protocolVersion !== PROTOCOL_VERSION || message.bridgeNonce !== bridgeNonce) return;
			if (message.type === "bonobo:init" && !initialized && typeof message.apiOrigin === "string" && typeof message.token === "string" && typeof message.tokenExpiresAt === "number" && Number.isFinite(message.tokenExpiresAt) && is_page_context(message.context)) {
				initialized = true;
			...
			} else if (message.type === "bonobo:token" && typeof message.requestId === "string" && typeof message.token === "string" && typeof message.tokenExpiresAt === "number" && Number.isFinite(message.tokenExpiresAt)) {
			...
			} else if (message.type === "bonobo:token-error" && typeof message.requestId === "string" && typeof message.message === "string") {
				const pending = pending_refreshes.get(message.requestId);
				if (pending) {
					pending_refreshes.delete(message.requestId);
					clearTimeout(pending.timeout);
		...
		connectionDeadline = setTimeout(() => {
			...
			reject(/* @__PURE__ */ new Error("Plugin page connection timed out"));
...
function App(props) {
	const media = (0, import_react.useMemo)(() => create_media_url_manager(props.client), [props.client]);
	const scan = (0, import_react.useMemo)(() => create_list_scan(props.client), [props.client]);
	const [route, setRoute] = (0, import_react.useState)(() => parse_route(window.location.hash));
	...
	const load_more = (0, import_react.useCallback)(async () => {
	...
	if (route.view === "file") {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileDetail, {
			nodeId: route.nodeId,
			item,
			media
		});
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { children: "Gallery" })
			}),
			items.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "gallery-grid",
				children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(GalleryTile, {
					item,
					media
				}, item.nodeId))
			}) : null,
			...
			error !== null ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			!loading && error === null && !hasMore && items.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "gallery-status",
				children: "No images or videos yet."
			}) : null,
			hasMore && !loading && error === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function use_media_url(media, nodeId, mode) {
	...
	const request_url = (0, import_react.useCallback)((fresh) => {
		const generation = generationRef.current;
		(fresh || mode === "fresh" ? media.get_fresh_url(nodeId) : media.get_url(nodeId)).then((media_url) => {
	...
	return {
		mediaUrl,
		errorMessage,
		notify_load_success: (0, import_react.useCallback)(() => {
			autoRenewSpentRef.current = false;
		}, []),
		notify_load_error: (0, import_react.useCallback)(() => {
...
function GalleryTile(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
			...
			children: [media_url.mediaUrl === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: media_url.errorMessage !== null ? "tile-placeholder is-failed" : "tile-placeholder" }) : is_video ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("video", {
		...
		}), media_url.errorMessage !== null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
function FileDetail(props) {
	...
	const handle_video_error = (0, import_react.useCallback)(() => {
		...
		if (video && Number.isFinite(video.currentTime)) restoreRef.current = {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
				...
				href: "#/",
				children: "← Gallery"
			}), item !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: media_url.errorMessage !== null ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "viewer-status is-error",
				role: "alert",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: media_url.errorMessage }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: "button",
					onClick: media_url.retry,
					children: "Retry"
				})]
			}) : media_url.mediaUrl === null ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "viewer-status",
				role: "status",
				"aria-live": "polite",
				children: "Loading…"
			}) : is_video ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("video", {
				ref: videoRef,
				src: media_url.mediaUrl.url,
				controls: true,
